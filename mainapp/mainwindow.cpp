        ...
        if(!currentPlugin.isNull())
        {
            ...
            if(currentPluginInstance)
            {
                ...
                try {
                    ...
                    QMessageBox::critical(this,
                                          tr("OpenCV exception caught!"),
                                          tr(
                                             "The reason you see this error is that "
                                             "the parameters you have chosen are invalid"
                                             " for the specific OpenCV functions. Sorry "
                                             "about that. The processed image is now set "
                                             "to be the exact copy of the original one unless"
                                             " you enter valid parameters."));
...
// this is not used now, but may later be used when I add plugins that use camera
